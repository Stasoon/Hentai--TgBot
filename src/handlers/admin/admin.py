...
admin_kb = ReplyKeyboardMarkup(resize_keyboard=True, one_time_keyboard=True, row_width=1)\
    .add(
        ...
        hentai.Keyboards.reply_button_for_admin_menu,
...
def register_admin_handlers(dp: Dispatcher):
    ...
    hentai.Handlers.register_hentai_handlers(dp)
    mailing.Handlers.register_mailing_handlers(dp)
    necessary_subscriptions.Handlers.register_subchecking_handlers(dp)
